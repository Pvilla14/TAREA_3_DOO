...
public class JPanelMonedas extends JPanel {
    public JPanelMonedas(MainVisual main, int largo, int ancho, JPanelExpendedor jpex) {
        super();
        setLayout(null);
        this.setBounds(0, 0, ancho/2, largo);
        Boton100 boton100 = new Boton100(main, this);
        boton100.setBounds(30, 10, 100, 100);
        this.add(boton100);
        Boton500 boton500 = new Boton500(main, this);
        boton500.setBounds(140, 10, 100, 100);
        this.add(boton500);
        Boton1000 boton1000 = new Boton1000(main, this);
        boton1000.setBounds(30, 120, 100, 100);
        this.add(boton1000);
        Boton1500 boton1500 = new Boton1500(main, this);
        ...
        JPanelDeposito Billetera = new JPanelDeposito(main.getBilletera());
